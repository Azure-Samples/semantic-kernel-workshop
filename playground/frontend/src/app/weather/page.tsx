                    ...
                    {weatherData.assistant_response && (
                      <Card className="border border-orange-100 bg-orange-50">
                        <CardContent className="p-4">
                          ...
                          <p>{weatherData.assistant_response}</p>
                        </CardContent>
                      </Card>
                    )}
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p>The plugin receives your city name as input</p>
              </div>
              
              <div className="flex items-start gap-3">
                <Badge className="bg-orange-100 text-orange-600 hover:bg-orange-100">Step 2</Badge>
                <p>It processes the request using simulated weather data</p>
              </div>
              
              <div className="flex items-start gap-3">
                <Badge className="bg-orange-100 text-orange-600 hover:bg-orange-100">Step 3</Badge>
                <p>An AI assistant analyzes the weather data and provides a natural language response</p>
              </div>
              
              <div className="flex items-start gap-3">
                <Badge className="bg-orange-100 text-orange-600 hover:bg-orange-100">Step 4</Badge>
                <p>You receive both the raw weather data and the AI's interpretation</p>
              </div>
            </div>
          </CardContent>
        </Card>
